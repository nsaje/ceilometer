...
OPTS = [
    cfg.StrOpt('backend_url',
               ...
               help='The backend URL to use for distributed coordination. If '
                    'left empty, certain services won\'t do workload '
...
class PartitionCoordinator(object):
    ...
    coordination backend is down. The `get_my_subset` will simply return an
    ...
    def heartbeat(self):
        if self._coordinator:
            ...
            try:
                ...
                LOG.debug('Sending heartbeat to coordination backend.')
            except tooz.coordination.ToozError:
    ...
    def get_my_subset(self, group_id, iterable):
        ...
        """
        if not group_id:
            LOG.debug('No group id defined, returning the whole iterable.')
            return iterable
