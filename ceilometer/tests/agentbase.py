...
class BaseAgentManagerTestCase(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.mgr.partition_coordinator.get_my_subset.side_effect = fake_subset
    ...
    def test_discovery_partitioning(self):
        ...
        self.assertEqual(len(expected),
                         len(p_coord.get_my_subset.call_args_list))
        for c in expected:
            self.assertIn(c, p_coord.get_my_subset.call_args_list)
